...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-22 21:17`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/03814cb0-ffb4-46fe-add7-e3c905fde84c.git
$ cd 03814cb0-ffb4-46fe-add7-e3c905fde84c
```
